# Website Projects - Complete Details

Generated from `assets/js/app.js` (projects array) and image assets under `assets/images/`.
...
- Gallery Folder: `assets/images/FCN`
- Screenshot Count: 9
- `assets/images/FCN/Screenshot_1.png`
- `assets/images/FCN/Screenshot_2.png`
- `assets/images/FCN/Screenshot_3.png`
- `assets/images/FCN/Screenshot_4.png`
- `assets/images/FCN/Screenshot_5.png`
- `assets/images/FCN/Screenshot_6.png`
- `assets/images/FCN/Screenshot_7.png`
- `assets/images/FCN/Screenshot_8.png`
- `assets/images/FCN/Screenshot_9.png`
...
### Image Assets In Repository
- Gallery Folder: `assets/images/FAI MEDICAL`
- Screenshot Count: 10
- `assets/images/FAI MEDICAL/Screenshot_1.png`
- `assets/images/FAI MEDICAL/Screenshot_2.png`
- `assets/images/FAI MEDICAL/Screenshot_3.png`
- `assets/images/FAI MEDICAL/Screenshot_4.png`
- `assets/images/FAI MEDICAL/Screenshot_5.png`
- `assets/images/FAI MEDICAL/Screenshot_6.png`
- `assets/images/FAI MEDICAL/Screenshot_7.png`
- `assets/images/FAI MEDICAL/Screenshot_8.png`
- `assets/images/FAI MEDICAL/Screenshot_9.png`
- `assets/images/FAI MEDICAL/Screenshot_10.png`
...
### Image Assets In Repository
- Gallery Folder: `assets/images/NoLimits`
- Screenshot Count: 6
- `assets/images/NoLimits/Screenshot_1.png`
- `assets/images/NoLimits/Screenshot_2.png`
- `assets/images/NoLimits/Screenshot_3.png`
- `assets/images/NoLimits/Screenshot_4.png`
- `assets/images/NoLimits/Screenshot_5.png`
- `assets/images/NoLimits/Screenshot_6.png`
...
### Image Assets In Repository
- Gallery Folder: `assets/images/LETSTALK`
- Screenshot Count: 6
- `assets/images/LETSTALK/Screenshot_1.png`
- `assets/images/LETSTALK/Screenshot_2.png`
- `assets/images/LETSTALK/Screenshot_3.png`
- `assets/images/LETSTALK/Screenshot_4.png`
- `assets/images/LETSTALK/Screenshot_5.png`
- `assets/images/LETSTALK/Screenshot_6.png`
...
### Image Assets In Repository
- Gallery Folder: `assets/images/TENDER SYSTEM`
- Screenshot Count: 8
- `assets/images/TENDER SYSTEM/Screenshot_1.png`
- `assets/images/TENDER SYSTEM/Screenshot_2.png`
- `assets/images/TENDER SYSTEM/Screenshot_3.png`
- `assets/images/TENDER SYSTEM/Screenshot_4.png`
- `assets/images/TENDER SYSTEM/Screenshot_5.png`
- `assets/images/TENDER SYSTEM/Screenshot_6.png`
- `assets/images/TENDER SYSTEM/Screenshot_7.png`
- `assets/images/TENDER SYSTEM/Screenshot_8.png`
...
### Image Assets In Repository
- Gallery Folder: `assets/images/SALMONE`
- Screenshot Count: 3
- `assets/images/SALMONE/Screenshot_1.png`
- `assets/images/SALMONE/Screenshot_2.png`
- `assets/images/SALMONE/Screenshot_3.png`
...
### Image Assets In Repository
- Dedicated screenshot folder not present in current repository.
